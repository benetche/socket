...
int main() {
  ...
  clientUi->implementCommand("/ping",
                             [client, clientUi](const GUI::argsT &args) {
  ...
  clientUi->implementCommand("/connect", [client,
                                          clientUi](const GUI::argsT &args) {
    if (args.size() != 2) {
  ...
  clientUi->implementCommand(
      "/join", [client, clientUi](const GUI::argsT &args) {
        if (args.size() != 2) {
          // Display error message if command is not used correctly
          clientUi->addToWindow(
  ...
  clientUi->implementCommand(
      "/mute", [client, clientUi](const GUI::argsT &args) {
        if (args.size() != 2) {
          // Display error message if command is not used correctly
  ...
  clientUi->implementCommand(
      "/whois", [client, clientUi](const GUI::argsT &args) {
        if (args.size() != 2) {
          // Display error message if command is not used correctly
          clientUi->addToWindow(
  ...
  clientUi->implementCommand(
      "/kick", [client, clientUi](const GUI::argsT &args) {
        if (args.size() != 2) {
          // Display error message if command is not used correctly
          clientUi->addToWindow(
  ...
  clientUi->implementCommand("/nickname", [client,
                                           clientUi](const GUI::argsT &args) {
    if (args.size() != 2) {
      // Display error message if command is not used correctly
